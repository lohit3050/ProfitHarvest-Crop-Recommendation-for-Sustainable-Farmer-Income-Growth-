...
# Load datasets
price_data = pd.read_csv(r'/workspaces/ProfitHarvest-Crop-Recommendation-for-Sustainable-Farmer-Income-Growth-/maize.csv')
file_path = r'/workspaces/ProfitHarvest-Crop-Recommendation-for-Sustainable-Farmer-Income-Growth-/Crop_recommendation (1).csv'
...
def recommend_top3_crops(input_data):
    ...
    top3_crops = [crop.capitalize() for crop in top3_crops]
    return top3_crops
...
def index():
    if request.method == 'POST':
        ...
        # Train models for recommended crops and make predictions
        predictions = {}
        ...
        return render_template('result.html', crops=recommended_crops, predictions=predictions)
